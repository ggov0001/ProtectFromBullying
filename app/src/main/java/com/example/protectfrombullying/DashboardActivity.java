...
public class DashboardActivity extends AppCompatActivity {
    ...
    private Button identityOfBulliesReport;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        identityOfBulliesReport = (Button) findViewById(R.id.button_identityOfBullies);

        cyberBullyReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DashboardActivity.this, DashboardYourKidsActivity.class);
                startActivity(intent);
            }
        });
    }
