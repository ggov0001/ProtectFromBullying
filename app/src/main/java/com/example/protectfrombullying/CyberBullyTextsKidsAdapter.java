...
public class CyberBullyTextsKidsAdapter extends RecyclerView.Adapter<CyberBullyTextsKidsAdapter.KidsViewHolder> {

    private Context context;
    public List<Kids> kidsList;

    public CyberBullyTextsKidsAdapter(Context context, List<Kids> kidsList) {
